...
<!--     tabindex="-1"><a aria-hidden="true" -->
  ...
  <p dir="auto">
    ...
    <p style="margin-top: 0px; text-size: 50px;" dir="auto">The goal of this Healthcare Data Engineering project is to serve a 'Fact & Dimension' Tables to the Reporting Team to run BI workloads and reports and perform advanced data analytics to gather insights on large-scale Healthcare Data using a wide range of Big Data tools, technologies and Azure cloud services. </p>
